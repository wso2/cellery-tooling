...
public class Constants {
    ...
    public static class CompletionProvider {
        ...
        public static final String CELL_RUN_FUNCTION_LABEL = CELLERY_PREFIX + "cell run function";
        public static final String COMPOSITE_BUILD_FUNCTION_LABEL = CELLERY_PREFIX + "composite build function";
        public static final String COMPOSITE_RUN_FUNCTION_LABEL = CELLERY_PREFIX + "composite run function";
    }
